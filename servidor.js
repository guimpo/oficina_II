...
app.get('/CadastrarDocumento', function (req, res, next) {
  try {
    fs.readFile(__dirname + '/views/cadastrarDocumento.html', function (err, data) {
      res.writeHead(200, { 'Content-Type': 'text/html' });
      res.write(data);
      res.end();
    })
...
app.get('/analise', function (req, res, next) {
  try {
    fs.readFile(__dirname + '/views/visualizarDocumento.html', function (err, data) {
      res.writeHead(200, { 'Content-Type': 'text/html' });
      res.write(data);
      res.end();
    })
